...
export function renderAuthor(editId = null) {
    ...
    container.innerHTML = `
      ...
      <h3>Author Capsule</h3>
      <div>
        <button class="btn btn-secondary me-2" id="backBtn" aria-label="Back">← Back</button>
        <button class="btn btn-success" id="saveBtn" aria-label="Save">💾 Save</button>
      </div>
    </div>
    <p class="text-light">Draft notes, flashcards, and quizzes.</p>
    ...
    <div class="row">
      ...
      <div class="col-md-6 mb-3">
        <div class="card bg-dark border border-white text-light p-3 h-100">
          ...
          <input id="meta-title" class="form-control" value="${meta.title || ""}" />

          <label class="mt-2">Subject</label>
          <input id="meta-subject" class="form-control" value="${meta.subject || ""}" />
          ...
          <textarea id="meta-description" rows="2" class="form-control">${meta.description || ""}</textarea>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-3">
        <div class="card bg-dark border border-white text-light p-3 h-100">
          ...
          <textarea id="notes" class="form-control" rows="10" placeholder="Write notes here...">${notes}</textarea>
        </div>
      </div>
    </div>
